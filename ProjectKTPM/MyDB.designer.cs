...
namespace ProjectKTPM
{
    ...
    partial void InsertSP_HD(SP_HD instance);
    partial void UpdateSP_HD(SP_HD instance);
    partial void DeleteSP_HD(SP_HD instance);
    ...
    partial void InsertDiaDiemPhongBan(DiaDiemPhongBan instance);
    partial void UpdateDiaDiemPhongBan(DiaDiemPhongBan instance);
    partial void DeleteDiaDiemPhongBan(DiaDiemPhongBan instance);
    ...
    partial void DeleteNhanVien(NhanVien instance);
		...
		public MyDBDataContext() : 
				base(global::ProjectKTPM.Properties.Settings.Default.minhquy_mydbConnectionString, mappingSource)
		{
			OnCreated();
		}
		...
		public System.Data.Linq.Table<SP_HD> SP_HDs
		{
			get
			{
				return this.GetTable<SP_HD>();
			}
		}
		...
		public System.Data.Linq.Table<DiaDiemPhongBan> DiaDiemPhongBans
		{
			get
			{
				return this.GetTable<DiaDiemPhongBan>();
			}
		}
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.SP_HD")]
	public partial class SP_HD : INotifyPropertyChanging, INotifyPropertyChanged
	{
	...
	public partial class Phong : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private short _TRUONGPHONG;
		
		private System.DateTime _NGAYNHANCHUC;
		
		private EntitySet<DiaDiemPhongBan> _DiaDiemPhongBans;
    ...
    partial void OnValidate(System.Data.Linq.ChangeAction action);
    partial void OnCreated();
    partial void OnMAPHONGChanging(byte value);
    partial void OnMAPHONGChanged();
    partial void OnTENPHONGChanging(string value);
    partial void OnTENPHONGChanged();
    partial void OnTRUONGPHONGChanging(short value);
    ...
    partial void OnNGAYNHANCHUCChanged();
		...
		public Phong()
		{
			this._DiaDiemPhongBans = new EntitySet<DiaDiemPhongBan>(new Action<DiaDiemPhongBan>(this.attach_DiaDiemPhongBans), new Action<DiaDiemPhongBan>(this.detach_DiaDiemPhongBans));
			this._NhanViens = new EntitySet<NhanVien>(new Action<NhanVien>(this.attach_NhanViens), new Action<NhanVien>(this.detach_NhanViens));
			this._NhanVien = default(EntityRef<NhanVien>);
			OnCreated();
		}
		
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_MAPHONG", DbType="TinyInt NOT NULL", IsPrimaryKey=true)]
		public byte MAPHONG
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_TRUONGPHONG", DbType="SmallInt NOT NULL")]
		public short TRUONGPHONG
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_NGAYNHANCHUC", DbType="Date NOT NULL")]
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Phong_DiaDiemPhongBan", Storage="_DiaDiemPhongBans", ThisKey="MAPHONG", OtherKey="MaPhong")]
		public EntitySet<DiaDiemPhongBan> DiaDiemPhongBans
		{
			get
			{
				return this._DiaDiemPhongBans;
			}
			set
			{
				this._DiaDiemPhongBans.Assign(value);
			}
		}
		
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Phong_NhanVien", Storage="_NhanViens", ThisKey="MAPHONG", OtherKey="PHONG")]
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="NhanVien_Phong", Storage="_NhanVien", ThisKey="TRUONGPHONG", OtherKey="MANV", IsForeignKey=true)]
		public NhanVien NhanVien
		{
			...
			set
			{
							...
							|| (this._NhanVien.HasLoadedOrAssignedValue == false)))
				{
					...
					{
						this._TRUONGPHONG = default(short);
					}
		...
		private void attach_DiaDiemPhongBans(DiaDiemPhongBan entity)
		{
			this.SendPropertyChanging();
			entity.Phong = this;
		}
		
		private void detach_DiaDiemPhongBans(DiaDiemPhongBan entity)
		{
			this.SendPropertyChanging();
			entity.Phong = null;
		}
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.DiaDiemPhongBan")]
	public partial class DiaDiemPhongBan : INotifyPropertyChanging, INotifyPropertyChanged
	{
    ...
    partial void OnDiaDiemChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_DiaDiem", DbType="NChar(50) NOT NULL", CanBeNull=false, IsPrimaryKey=true)]
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Phong_DiaDiemPhongBan", Storage="_Phong", ThisKey="MaPhong", OtherKey="MAPHONG", IsForeignKey=true)]
		public Phong Phong
		{
			get
			{
			...
			set
			{
							...
							|| (this._Phong.HasLoadedOrAssignedValue == false)))
				{
					...
					if ((previousValue != null))
					{
						...
						previousValue.DiaDiemPhongBans.Remove(this);
					}
					this._Phong.Entity = value;
					if ((value != null))
					{
						value.DiaDiemPhongBans.Add(this);
						this._MaPhong = value.MAPHONG;
					}
					else
					{
						this._MaPhong = default(byte);
					}
	...
	public partial class NhanVien : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private System.Nullable<short> _NQL;
		
		private System.Nullable<byte> _PHONG;
    ...
    partial void OnValidate(System.Data.Linq.ChangeAction action);
    partial void OnCreated();
    partial void OnMANVChanging(short value);
    ...
    partial void OnNQLChanging(System.Nullable<short> value);
    partial void OnNQLChanged();
    partial void OnPHONGChanging(System.Nullable<byte> value);
    partial void OnPHONGChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_MANV", DbType="SmallInt NOT NULL", IsPrimaryKey=true)]
		public short MANV
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_TENLOT", DbType="NVarChar(50)")]
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_NS", DbType="DateTime2")]
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_DC", DbType="NVarChar(50) NOT NULL", CanBeNull=false)]
		public string DC
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_NQL", DbType="SmallInt")]
		public System.Nullable<short> NQL
		{
			get
			{
				return this._NQL;
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_PHONG", DbType="TinyInt")]
		public System.Nullable<byte> PHONG
		{
			get
			{
				return this._PHONG;
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="NhanVien_Phong", Storage="_Phongs", ThisKey="MANV", OtherKey="TRUONGPHONG")]
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Phong_NhanVien", Storage="_Phong1", ThisKey="PHONG", OtherKey="MAPHONG", IsForeignKey=true)]
		public Phong Phong1
		{
			get
			{
			...
			set
			{
							...
							|| (this._Phong1.HasLoadedOrAssignedValue == false)))
				{
					...
					{
						this._PHONG = default(Nullable<byte>);
					}
